...
public class Dialog {
   ...
   public void MainMenu() {
      ...
      final int MM_NEUARTIKEL = 2;
      final int MM_NEUARTIKEL_ARTIKEL = 1;
      final int MM_NEUARTIKEL_VIDEO = 2;
      final int MM_NEUARTIKEL_CD = 3;
      final int MM_NEUARTIKEL_BUCH = 4;
      while (true) {
         switch (leseInt(String.format("\nFunktion wählen %d: Ende, %d: Bestandsliste, %d: neuer Artikel\t", MM_ENDE,
               MM_AUSGABEBESTAND, MM_NEUARTIKEL))) {
         case MM_ENDE:
            return;
         ...
         case MM_NEUARTIKEL:
            ...
            switch (leseInt(
                  String.format("neuer Artikel - Art wählen %d: Artikel, %d: Video, %d: CD, %d: Buch (0:Ende)\t",
                        MM_NEUARTIKEL_ARTIKEL, MM_NEUARTIKEL_VIDEO, MM_NEUARTIKEL_CD, MM_NEUARTIKEL_BUCH))) {
            case MM_ENDE:
               return;
